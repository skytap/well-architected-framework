...
maintained within your account and the management of your {{site.Brand}} account
itself. This document outlines architectural elements necessary to
achieve a robust implementation on the {{site.Brand}} platform and best
practices for how your {{site.Brand}} account should be configured.
...
account best practices of how to leverage {{site.Brand}}. Each layer in this
...
Accompanying this document is a **{{site.Brand}} - Security Controls Workbook**
...
Similar to other cloud services, {{site.Brand}} operates a shared responsibility
model with regards to security. {{site.Brand}} is accountable for the platform
...
Additionally, resources deployed into {{site.Brand}} should have a
...
-   Are there services external to {{site.Brand}} that need to be supported for
    your workloads?
