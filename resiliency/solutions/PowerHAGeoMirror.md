...
This document explains how to configure a basic two-node geographic mirroring environment within {{site.SoA}} across different regions with Network connectivity in place, leveraging local storage to the partition. We will use an IBM i PowerHA two-node cluster (Primary node configured in Region 1 and Backup Node in Region 2) with Geo Mirroring. It is important to note that the user can use this document to extend their on-premises HA/DR environment, and/or use this as a pattern for having both Production and HA/DR entirely in the cloud.
...
![](https://skytap.github.io/well-architected-framework/resiliency/solutions/powerha-geomirror-media/image1.png)
...
1. Provisioning of IBM i LPAR (VM) as Backup Node on cloud.skytap.com including PowerHA Licensed Program license inclusion in Region 2.
  ...
  ![](https://skytap.github.io/well-architected-framework/resiliency/solutions/powerha-geomirror-media/image2.png)

1. The best practice is to verify PTFs and other prerequisites on both IBM i nodes are up-to-date.

    ![](https://skytap.github.io/well-architected-framework/resiliency/solutions/powerha-geomirror-media/image3.png)

1. Provisioning of Windows VM as a node to host IBM i ACS (Access Client Solutions). This will be used for the 5250 Emulator and Navigator for i.
1. Testing of communication between the three nodes via network reachability. The network provisioning across Geo locations would include the following:

    1. Provisioning/Configuration of VPN between regions via WAN links.
    1. Each WAN and VPN configured within it should have its own subnets.
    1. The VMs must be attached to the configured WAN/VPNs.

        ![](https://skytap.github.io/well-architected-framework/resiliency/solutions/powerha-geomirror-media/image4.png)<br>

        ![](https://skytap.github.io/well-architected-framework/resiliency/solutions/powerha-geomirror-media/image5.png)

      All Three nodes can interact with each other over the network. Refer to the following screen capture as an example.

      ![](https://skytap.github.io/well-architected-framework/resiliency/solutions/powerha-geomirror-media/image6.png)

1. Configuration of PowerHA (Primary and Backup Nodes) including Activation of nodes, Domain Name additions, iASP configurations, Cluster Resource Groups and associated device registration, GEO Mirror Configurations and testing of Geo Mirror based switch over.
...
![](https://skytap.github.io/well-architected-framework/resiliency/solutions/powerha-geomirror-media/image7.png)
...
![](https://skytap.github.io/well-architected-framework/resiliency/solutions/powerha-geomirror-media/image8.png)
...
![](https://skytap.github.io/well-architected-framework/resiliency/solutions/powerha-geomirror-media/image9.png)

![](https://skytap.github.io/well-architected-framework/resiliency/solutions/powerha-geomirror-media/image10.png)
...
![](https://skytap.github.io/well-architected-framework/resiliency/solutions/powerha-geomirror-media/image11.png)
...
```
![](https://skytap.github.io/well-architected-framework/resiliency/solutions/powerha-geomirror-media/image12.png)

![](https://skytap.github.io/well-architected-framework/resiliency/solutions/powerha-geomirror-media/image13.png)

![](https://skytap.github.io/well-architected-framework/resiliency/solutions/powerha-geomirror-media/image14.png)
...
![](https://skytap.github.io/well-architected-framework/resiliency/solutions/powerha-geomirror-media/image15.png)
...
![](https://skytap.github.io/well-architected-framework/resiliency/solutions/powerha-geomirror-media/image16.png)

Once varied on, you should see the following message.

![](https://skytap.github.io/well-architected-framework/resiliency/solutions/powerha-geomirror-media/image17.png)
