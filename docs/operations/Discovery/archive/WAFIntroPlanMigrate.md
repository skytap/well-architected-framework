# Cloud Rationalization and IBM Power Workloads

\<Internal Note, starting
[here](https://docs.microsoft.com/en-us/azure/cloud-adoption-framework/plan/)\>

IBM Power Workloads have been in use for over thirty years and have
unique considerations when migrating them to a Cloud Platform. The
common [Cloud
...
\<[Internal note, think
here](https://docs.microsoft.com/en-us/azure/cloud-adoption-framework/plan/contoso-migration-assessment)\>
